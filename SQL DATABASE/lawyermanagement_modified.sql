...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 02, 2022 at 11:49 PM
...
(2, '2019-04-24', 'ok test', 'Client5cbab2a1987da', 'Lawyer5cba0637a2a93', 'Accepted'),
...
('Client5cb6315a228dd', 'ok', 'ok1', 'user@gmail.com ', '123456', 'Active', 'User'),
('Client5cbab2a1987da', 'hosen', 'arnab', 'user1@gmail.com ', '123456', 'Active', 'User'),
('Client5cbb36c2cfd64', 'Arman', 'hosen', 'rocks@gmail.com ', '098765', 'Active', 'User'),
('Lawyer5cba0637a2a93', 'Husam', 'hossam', 'lawyer@gmail.com ', '123456', 'Active', 'Lawyer'),
...
-- Add a new role 'subadmin'
INSERT INTO `user` (`u_id`, `first_Name`, `last_Name`, `email`, `password`, `status`, `role`) VALUES
('SubAdmin001', 'Sub', 'Admin', 'subadmin@example.com', 'password', 'active', 'subadmin');

-- Table structure for file management
...
-- Table structure for notification center
